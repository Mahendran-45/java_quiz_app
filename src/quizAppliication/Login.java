...
public class Login extends JFrame{
	...
	public Login(){
		...
		super.setIconImage(new ImageIcon(new File("res/Icon.png").getAbsolutePath()).getImage());
	...
	private void prepareGUI() {
		...
		//loginImage.setIcon(new ImageIcon(getClass().getResource("res/Logo.png")));
		//loginImage.setIcon(new ImageIcon(getClass().getResource("/Users/mahendran/Downloads/QuizApplication-java-swing-master/res/Logo.png")));

		File file = new File("res/Logo.png");
		if (file.exists()) {
			loginImage.setIcon(new ImageIcon(file.getAbsolutePath()));
		} else {
